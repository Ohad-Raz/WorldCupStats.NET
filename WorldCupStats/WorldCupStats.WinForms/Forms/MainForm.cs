...
namespace WorldCupStats.WinForms
{
    ...
    {
        // Additional features include drag and drop, multi-select, rankings and printing
        ...
        // Saves favorite players from the panel to disk
        ...
        private async void BtnSettings_Click(object sender, EventArgs e)
        {
            ...
            // Clears old team data before reloading with new settings
        ...
        private void MainForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            DialogResult result = MessageBox.Show(
               ...
               MessageBoxDefaultButton.Button1); // Makes OK the default button
        ...
        {
            // 1. Ctrl is required to avoid conflict with drag and drop
            if ((ModifierKeys & Keys.Control) != Keys.Control)
            { return; }
        ...
        // Resets print pagination row indexes and starts with player rankings
